...
gpg --output $VERSION-linux/$NAME/scala-linux-$VERSION-build.assert.sig --detach-sign $VERSION-linux/$NAME/scala-linux-$VERSION-build.assert
gpg --output $VERSION-osx-unsigned/$NAME/scala-osx-$VERSION-build.assert.sig --detach-sign $VERSION-osx-unsigned/$NAME/scala-osx-$VERSION-build.assert
gpg --output $VERSION-win-unsigned/$NAME/scala-win-$VERSION-build.assert.sig --detach-sign $VERSION-win-unsigned/$NAME/scala-win-$VERSION-build.assert
```
...
```bash
gpg --detach-sign ${VERSION}-linux/${SIGNER}/scala-linux-*-build.assert
gpg --detach-sign ${VERSION}-win-unsigned/${SIGNER}/scala-win-*-build.assert
gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/scala-osx-*-build.assert
```
