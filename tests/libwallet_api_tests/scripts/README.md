...
* Running scala node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/scalaexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/scala/testnet_pvt```. 
